...
const Router = (() => {
  ...
  const routes = {
    ...
    "novel":       { page: "novel-detail", title: "รายละเอียด" },
    "reader":      { page: "reader", title: "อ่าน" },
    "library":     { page: "library", title: "หอสมุด" },
    "search":      { page: "search", title: "ค้นหา" },
    "ranking":     { page: "ranking", title: "อันดับ" },
    "profile":     { page: "profile", title: "โปรไฟล์" },
    "history":     { page: "history", title: "ประวัติ" },
    "bookmarks":   { page: "bookmarks", title: "บุ๊กมาร์ก" },
    "downloads":   { page: "downloads", title: "ดาวน์โหลด" },
    "notifications": { page: "notifications", title: "การแจ้งเตือน" },
    "settings":    { page: "settings", title: "ตั้งค่า" },
    "admin":       { page: "admin", title: "หลังบ้าน" },
    "admin-novels": { page: "admin-novels", title: "จัดการนิยาย" },
    "admin-chapters": { page: "admin-chapters", title: "จัดการตอน" },
    "admin-translate": { page: "admin-translate", title: "ศูนย์แปล" },
    "admin-translate-job": { page: "admin-translate-job", title: "เปรียบเทียบการแปล" },
    "admin-novel-edit": { page: "admin-novel-edit", title: "แก้ไขนิยาย" },
    "admin-users": { page: "admin-users", title: "จัดการผู้ใช้" },
    "admin-glossary": { page: "admin-glossary", title: "Glossary" },
  };
