  ...
  async render(params) {
    ...
    try {
      ...
      page.innerHTML = '<div class="c-container">' + renderAdminNav('dashboard') +
        ...
        '<div class="c-stats"><div class="c-stat"><span class="c-stat__num">' + novels.length + '</span><span class="c-stat__label">นิยายทั้งหมด</span></div>' +
        '<div class="c-stat"><span class="c-stat__num">' + totalChapters + '</span><span class="c-stat__label">ตอนที่แปลแล้ว</span></div></div></div>';
...
const AdminGlossaryPage = {
  async render(params) {
    ...
    try {
      ...
      } catch(e) { html += '<tr><td colspan="4" class="u-text-center u-text-muted">ไม่สามารถโหลดคำศัพท์ได้</td></tr>'; }
...
const AdminNovelEditPage = {
  async render(params) {
    ...
    } catch(e) { Ui.showError(page, 'เกิดข้อผิดพลาด'); }
  }
};
...
const BookmarksPage = {
  render(params) {
    ...
    try {
      ...
      page.innerHTML = html;
    } catch(e) { page.innerHTML = '<div class="c-container"><p class="u-text-muted u-text-center u-p-lg">ไม่มีบุ๊กมาร์ก</p></div>'; }
  }
};
